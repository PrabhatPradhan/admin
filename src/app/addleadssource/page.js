  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen">
      ...
      <div className="flex-1 overflow-y-auto bg-gray-100">
        ...
        {/* Header */}
        <div className="bg-white px-4 md:px-6 py-4 shadow-sm border-b flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
            ...
            {isModalOpen && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-6 overflow-y-auto max-h-[90vh]">
                  <h2 className="text-xl font-semibold mb-4">Add Lead Source</h2>
                  <input
                    type="text"
